...
namespace Backend.Repositories
{
    public class SaleRepository : ISaleRepository
    {
        ...
        public async Task<PaginatedResponse<Sale>> GetAllSalesAsync()
        {
            ...
            {
                // Only read StartIndex/EndIndex/TotalRecords from first row
                if (firstRow)
                {
                ...
                response.Data.Add(new Sale
                {
                    ...
                    SaleDetails = new List<Sale.SaleDetailDto>() // You can populate details separately if needed
                });
            }
