...
namespace Backend.Repository
{
    public class ProductRepository : IProductRepository
    {
        ...
        public async Task<PaginatedResponse<Product>> GetAllProductsAsync(int startIndex, int endIndex)
        {
            ...
            // ✅ Pass StartIndex and EndIndex to SQL
            ...
            while (await reader.ReadAsync())
            {
                ...
                response.Data.Add(new Product
                {
                    ...
                    CostPrice = reader.IsDBNull(reader.GetOrdinal("CostPrice")) ? null : reader.GetDecimal(reader.GetOrdinal("CostPrice")),
                    RetailPrice = reader.IsDBNull(reader.GetOrdinal("RetailPrice")) ? null : reader.GetDecimal(reader.GetOrdinal("RetailPrice")),
                    CreationDate = reader.IsDBNull(reader.GetOrdinal("CreationDate")) ? null : reader.GetDateTime(reader.GetOrdinal("CreationDate")),
